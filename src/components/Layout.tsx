    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-56 flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-20">
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700 space-y-1">
          ...
          <button
            onClick={signOut}
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/10 w-full"
          >
            <LogOut className="w-4 h-4" />
            Sign Out
          </button>
